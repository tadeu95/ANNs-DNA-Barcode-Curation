...
# Replace 'your_file_path.tsv' with the actual path to your training set (tsv format)
...
sns.heatmap(conf_matrix, annot=True, cmap='Blues', fmt='g', 
            xticklabels=['Predicted Unreliable', 'Predicted Reliable'], 
            yticklabels=['Actual Unreliable', 'Actual Reliable'])
